...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('home_homepage', (
            ('page_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['pages.Page'], unique=True, primary_key=True)),
            ('home_theme', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal('home', ['HomePage'])

        # Adding M2M table for field feat_tuts on 'HomePage'
        db.create_table('home_homepage_feat_tuts', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('homepage', models.ForeignKey(orm['home.homepage'], null=False)),
            ('tutorial', models.ForeignKey(orm['tutorial.tutorial'], null=False))
        ))
        db.create_unique('home_homepage_feat_tuts', ['homepage_id', 'tutorial_id'])

        # Adding model 'HomeSlides'
        db.create_table('home_homeslides', (
            ...
            ('response_img', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True)),
            ('description', self.gf('django.db.models.fields.TextField')(null=True)),
            ('homepage', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['home.HomePage'])),
        ))
        db.send_create_signal('home', ['HomeSlides'])


    def backwards(self, orm):
        # Deleting model 'HomePage'
        db.delete_table('home_homepage')

        # Removing M2M table for field feat_tuts on 'HomePage'
        db.delete_table('home_homepage_feat_tuts')

        # Deleting model 'HomeSlides'
        db.delete_table('home_homeslides')
    ...
    models = {
        ...
        'home.homepage': {
            'Meta': {'ordering': "('_order',)", 'object_name': 'HomePage', '_ormbases': ['pages.Page']},
            'feat_tuts': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['tutorial.Tutorial']", 'symmetrical': 'False', 'blank': 'True'}),
            'home_theme': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'page_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['pages.Page']", 'unique': 'True', 'primary_key': 'True'})
        },
        'home.homeslides': {
            'Meta': {'object_name': 'HomeSlides'},
            'description': ('django.db.models.fields.TextField', [], {'null': 'True'}),
            'homepage': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['home.HomePage']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'response_img': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True'}),
        ...
        'tutorial.tutorial': {
            'Meta': {'ordering': "('position',)", 'object_name': 'Tutorial', '_ormbases': ['pages.Page']},
