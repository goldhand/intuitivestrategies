...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CaroselImage.page'
        db.add_column('carosel_caroselimage', 'page',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['author.Author'], null=True),
                      keep_default=False)
        ...
        # Deleting field 'Carosel.authors'
        db.delete_column('carosel_carosel', 'authors_id')
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'CaroselImage.page'
        db.delete_column('carosel_caroselimage', 'page_id')

        # Deleting field 'CaroselImage.carosels'
        db.delete_column('carosel_caroselimage', 'carosels_id')


        # User chose to not deal with backwards NULL issues for 'Carosel.caroselimages'
        raise RuntimeError("Cannot reverse this migration. 'Carosel.caroselimages' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Carosel.authors'
        raise RuntimeError("Cannot reverse this migration. 'Carosel.authors' and its values cannot be restored.")
    ...
    models = {
        ...
        'carosel.caroselimage': {
            ...
            'page': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['author.Author']", 'null': 'True'}),
