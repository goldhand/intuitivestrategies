...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Carosel.carosel_name'
        db.add_column('carosel_carosel', 'carosel_name',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Carosel.carosel'
        raise RuntimeError("Cannot reverse this migration. 'Carosel.carosel' and its values cannot be restored.")
        # Deleting field 'Carosel.carosel_name'
        db.delete_column('carosel_carosel', 'carosel_name')
