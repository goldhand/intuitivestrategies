...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field categories on 'Tutorial'
        db.create_table('tutorial_tutorial_categories', (
        ...
        db.create_unique('tutorial_tutorial_categories', ['tutorial_id', 'blogcategory_id'])

        # Adding model 'Section'
        db.create_table('tutorial_section', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('position', self.gf('django.db.models.fields.IntegerField')()),
            ('content', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('tutorial', ['Section'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field categories on 'Tutorial'
        db.delete_table('tutorial_tutorial_categories')

        # Deleting model 'Section'
        db.delete_table('tutorial_section')
    ...
    models = {
        ...
        'tutorial.tutorial': {
            'Meta': {'ordering': "('-publish_date',)", 'object_name': 'Tutorial', '_ormbases': ['pages.Page']},
            'allow_comments': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'categories': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'tutorials'", 'blank': 'True', 'to': "orm['blog.BlogCategory']"}),
