...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('author', ['Author'])

        # Adding model 'Book'
        db.create_table('author_book', (
        ...
        db.send_create_signal('author', ['Book'])


    def backwards(self, orm):
        # Deleting model 'Author'
        db.delete_table('author_author')

        # Deleting model 'Book'
        db.delete_table('author_book')
