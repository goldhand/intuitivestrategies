...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Splash'
        db.create_table('blankpage_splash', (
            ('page_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['pages.Page'], unique=True, primary_key=True)),
        ))
        db.send_create_signal('blankpage', ['Splash'])


    def backwards(self, orm):
        # Deleting model 'Splash'
        db.delete_table('blankpage_splash')


    models = {
        'blankpage.splash': {
            'Meta': {'ordering': "('_order',)", 'object_name': 'Splash', '_ormbases': ['pages.Page']},
