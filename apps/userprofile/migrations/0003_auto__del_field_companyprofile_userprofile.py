...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('userprofile_companyprofile', 'userprofile_id')
    ...
    def backwards(self, orm):
        # Adding field 'CompanyProfile.userprofile'
        db.add_column('userprofile_companyprofile', 'userprofile',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['userprofile.UserProfile'], null=True, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        'userprofile.userprofile': {
            ...
            'companyprofile': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['userprofile.CompanyProfile']", 'null': 'True', 'blank': 'True'}),
