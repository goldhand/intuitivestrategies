...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CompanyProfile.profile_image'
        db.alter_column('userprofile_companyprofile', 'profile_image', self.gf('django.db.models.fields.files.ImageField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'CompanyProfile.profile_image'
        db.alter_column('userprofile_companyprofile', 'profile_image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))
    ...
    models = {
        ...
        'userprofile.companyprofile': {
            ...
            'profile_image': ('django.db.models.fields.files.ImageField', [], {'default': "'home/will/Workspace/django/mezzanine/myproject/static/img/bg_blue.gif'", 'max_length': '100'}),
