...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CompanyProfile.title'
        db.delete_column('userprofile_companyprofile', 'title')

        # Deleting field 'CompanyProfile.slug'
        db.delete_column('userprofile_companyprofile', 'slug')

        # Deleting field 'CompanyProfile.id'
        db.delete_column('userprofile_companyprofile', 'id')

        # Adding field 'CompanyProfile.page_ptr'
        db.add_column('userprofile_companyprofile', 'page_ptr',
                      self.gf('django.db.models.fields.related.OneToOneField')(default='none', to=orm['pages.Page'], unique=True, primary_key=True),
                      keep_default=False)

        # Adding field 'CompanyProfile.company_title'
        db.add_column('userprofile_companyprofile', 'company_title',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'CompanyProfile.title'
        db.add_column('userprofile_companyprofile', 'title',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'CompanyProfile.slug'
        raise RuntimeError("Cannot reverse this migration. 'CompanyProfile.slug' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'CompanyProfile.id'
        raise RuntimeError("Cannot reverse this migration. 'CompanyProfile.id' and its values cannot be restored.")
        # Deleting field 'CompanyProfile.page_ptr'
        db.delete_column('userprofile_companyprofile', 'page_ptr_id')

        # Deleting field 'CompanyProfile.company_title'
        db.delete_column('userprofile_companyprofile', 'company_title')
